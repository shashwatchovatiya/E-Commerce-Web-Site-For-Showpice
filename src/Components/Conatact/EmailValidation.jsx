        ...
        <>
            ...
            <div className='conatiner md:px-20 mt-10 md:flex justify-center gap-10 mb-28'>
                ...
                <div className="md:w-[40%]  flex flex-col space-y-7 bg-[#F9F1E7] md:px-6 px-3 py-6">
                    ...
                    <div className="">
                        <span className='text-lg'>Convinced yet? Let's make something great together.</span>
                    </div>
                    ...
                    <div className="">
                        ...
                        <div className="flex justify-around">
                            ...
                            <div className="">
                                ...
                                <div className="bg-white p-2 rounded-full">
                                    <div className="border border-dashed border-black p-4 text-3xl rounded-full "><IoCall /></div>
                                </div>
                            ...
                            <div className="flex flex-col w-1/2">
                                ...
                                <span className='lg:text-2xl text-xl'>+91 8866187676</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-5 flex justify-around">
                            ...
                            <div className="">
                                ...
                                <div className="bg-white p-2 rounded-full">
                                    <div className="border border-dashed border-black p-4 text-3xl rounded-full "><IoMdMail /></div>
                                </div>
                            ...
                            <div className="flex flex-col w-1/2">
                                ...
                                <span className=''>info@ygntechnologies.com</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-5 flex justify-around">
                            ...
                            <div className="">
                                <div className="bg-white p-2 rounded-full">
                                    <div className="border border-dashed border-black p-4 text-3xl rounded-full "><FaLocationDot /></div>
                            ...
                            <div className="flex flex-col w-1/2">
                                ...
                                <span className=''>B2 1307, Goyal palladium tower,
                                    near Vodafone house,
                                    Makarba, Ahmedabad, 380051</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="">
                        ...
                        <div className="flex gap-3 mt-4">
                            <Link to='https://www.facebook.com/share/gMASg9Snh2sob9NW/?mibextid=qi2Omg' target='_blank'>
                            ...
                            <Link to='https://www.instagram.com/shashwat_0046?igsh=NGVhN2U2NjQ0Yg==' target='_blank'>
                                <div className="bg-white p-3 rounded-full hover:bg-slate-800 hover:text-white transition-all duration-300">

                                    <span className=''><FaInstagram /></span>
                                </div>
                            </Link>
                            <Link to='https://www.linkedin.com/in/shashwat-chovatiya-1151a92b8/' target='_blank'>
                                <div className="bg-white p-3 rounded-full hover:bg-slate-800 hover:text-white transition-all duration-300">

                                    <span className=''><FaLinkedinIn /></span>
                                </div>
                            </Link>
                            <Link to='https://wa.me/918866187676?text=Hello How can ihelp u ?' target='_blank'>
                                <div className="bg-white p-3 rounded-full hover:bg-slate-800 hover:text-white transition-all duration-300">
                ...
                <div className="md:w-[60%]  px-10 py-12">
                    <div className="">
                        <span className='md:text-4xl text-3xl sm:font-semibold font-bold'>Drop Us A Line</span>
                    </div>
                    <div className="mt-5">
                        <span className='text-xl'>Reach out to us from our contact form and we will get back to you shortly.</span>
                    </div>
                    <div className="">
